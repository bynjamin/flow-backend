...
class RemovePermissionMutation extends Mutation {

    protected $attributes = [
        'name' => 'RemovePermission',
        'description' => 'Remove permission to group or user.'
    ];
	...
	public function resolve($root, $args)
	{
        ...
        if (($args['type'] == 'Group') || ($args['type'] == 'Role')) {
            ...
            $group->permissions()->detach($args['permissionId']);
            ...
            $user->permissions()->detach($args['permissionId']);
